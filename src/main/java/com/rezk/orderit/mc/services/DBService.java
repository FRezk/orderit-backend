...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, "Fernando Rezk", "frezk@gmail.com", "45791346825",
				TipoCliente.PESSOA_JURIDICA);
		Endereco e3 = new Endereco(null, "Eurico Gaspar Dultra", "1801", "Apto. 06", "Parada Inglesa", "020518-000",
				cli1, c2);
